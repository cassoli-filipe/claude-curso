...
export function PreviewFrame() {
  ...
  if (error) {
    if (error === "firstLoad") {
      return (
        <div className="h-full flex items-center justify-center p-8 bg-[#FAF9F6]">
          <div className="text-center max-w-md">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[#FBE9E0] mb-4">
              <svg
    ...
    return (
      <div className="h-full flex items-center justify-center p-8 bg-[#FAF9F6]">
        <div className="text-center max-w-md">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[#F0EDE8] mb-4">
            <AlertCircle className="h-8 w-8 text-[#a89f96]" />
          </div>
          <h3 className="text-lg font-semibold text-[#1a1714] mb-2">
            No Preview Available
          </h3>
          <p className="text-sm text-[#6b6560]">{error}</p>
          <p className="text-xs text-[#a89f96] mt-2">
