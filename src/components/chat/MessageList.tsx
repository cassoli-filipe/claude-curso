  ...
  if (messages.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-full px-4 text-center">
        <div className="flex items-center justify-center w-14 h-14 rounded-2xl bg-[#FBE9E0] mb-4 shadow-sm">
          <Bot className="h-7 w-7 text-[#D97757]" />
        </div>
          ...
          >
            {message.role === "assistant" && (
              <div className="flex-shrink-0">
                <div className="w-9 h-9 rounded-lg bg-[#FBE9E0] border border-[#E8D5C8] shadow-sm flex items-center justify-center">
                  <Bot className="h-4.5 w-4.5 text-[#D97757]" />
                </div>
              </div>
            )}
            ...
            <div className={cn(
              ...
              <div className={cn(
                ...
                message.role === "user" 
                  ...
                  : "bg-white text-[#1a1714] border border-[#E8E3DC] shadow-sm"
              )}>
            ...
            {message.role === "user" && (
              <div className="flex-shrink-0">
                <div className="w-9 h-9 rounded-lg bg-[#D97757] shadow-sm flex items-center justify-center">
